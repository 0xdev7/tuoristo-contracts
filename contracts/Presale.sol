...
contract TokenPresale is Ownable {
    ...
    constructor(Token _token, address _mainWallet) {
        token = _token;
        mainWallet = _mainWallet;
        
        targetAmount = 2000 * 10**18;
        rewardTokenCount = 2 * 10**15;
    }
    ...
    function deposit() public payable {
        require(targetAmount >= depositedAmount.add(msg.value), "Presale: Input valid amount");
